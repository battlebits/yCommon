...
public enum Tag {
	...
	public String getPrefix(Language language) {
		String tag = prefix;
		for (String strTag : new String[] { "owner", "star", "admin", "manager", "streamer", "modplus", "mod", "trial", "helper", "staff", "builder", "developer", "youtuber", "youtuberplus", "tournament", "winner" })
