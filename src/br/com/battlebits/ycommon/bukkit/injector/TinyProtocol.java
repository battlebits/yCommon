...
public abstract class TinyProtocol {
	...
	/**
	 * Construct a new instance of TinyProtocol, and start intercepting packets
	...
	private void createServerChannelHandler() {
		...
		endInitProtocol = new ChannelInitializer<Channel>() {
			...
			protected void initChannel(Channel channel) throws Exception {
				try {
					// This can take a while, so we need to stop the main thread
					// from interfering
	 ...
	 * 
	 * @param reciever
	 *            - the receiving player, NULL for early login/status packets.
	 * @param channel
	 *            - the channel that received the packet. Never NULL.
	 * @param remoteAddress
	 *            - remote address of the sending client. Never NULL.
	 * @param packet
	 ...
	 * <p>
	 * Use {@link Channel#remoteAddress()} to get the remote address of the
	 * client.
	 * 
	 * @param sender
	 *            - the player that sent the packet, NULL for early login/status
	 *            packets.
	 * @param channel
	 *            - channel that received the packet. Never NULL.
	 * @param packet
	 ...
	 * <p>
	 * Note that {@link #onPacketOutAsync(Player, Object)} will be invoked with
	 * this packet.
	 * 
	 * @param player
	 ...
	 * 
	 * @param channel
	 *            - client identified by a channel.
	 * @param packet
	 *            - the packet to send.
	 */
	 ...
	 * <p>
	 * Note that {@link #onPacketInAsync(Player, Object)} will be invoked with
	 * this packet.
	 * 
	 * @param player
	...
	/**
	 * Retrieve the name of the channel injector, default implementation is
	 * "tiny-" + plugin name + "-" + a unique ID.
	 * <p>
	 * Note that this method will only be invoked once. It is no longer
	 * necessary to override this to support multiple instances.
	 * 
	...
	/**
	 * Channel handler that is inserted into the player's channel pipeline,
	 * allowing us to intercept sent and received packets.
	 * 
	 * @author Kristian
	 */
