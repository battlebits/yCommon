...
public class TagListener implements Listener {
	...
	public void onPlayerJoinListener(PlayerJoinEvent e) {
		...
		for (Player o : Bukkit.getOnlinePlayers()) {
			if (o.getPlayer().getUniqueId() != e.getPlayer().getUniqueId()) {
				...
				main.getBattleScoreboard().createTeam(e.getPlayer(), getTeamName(bp.getTag(), bp.getLiga()),
	...
	private char[] chars = new char[] { 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v',
			'w', 'x', 'y', 'z' };
