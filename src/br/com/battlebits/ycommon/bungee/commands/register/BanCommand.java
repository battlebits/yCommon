...
public class BanCommand extends CommandClass {
	...
	@Command(name = "mute", usage = "/<command> <player> <reason>", aliases = { "mutar" }, groupToUse = Group.HELPER, noPermMessageId = "command-mute-no-access")
	...
	@Command(name = "tempmute", usage = "/<command> <player> <time> <reason>", aliases = { "tempmutar" }, groupToUse = Group.HELPER, noPermMessageId = "command-tempmute-no-access")
